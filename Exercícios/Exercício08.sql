...
select * from cliente;
insert into cliente values(8, '20000200000', 'Bruno', 20, 'Bom Retiro', 'Joinville');
update cliente set cpf = '20000200000' where cliente.nome = 'Ana';
...
insert into mecanico values(6, '12331414123', 'Paulão da Regulagem', 21, 'Lapa', 'São Paulo', 'câmbio', null);
...
select * from cliente;
insert into cliente values (10, '12943869996', 'Augustinho Carrara', 32, 'Lapa', 'São Paulo');
...
insert into mecanico values(10, '00000000000', 'Paulão da Regulagem', 21, 'Lapa', 'São Paulo', 'câmbio', null);
